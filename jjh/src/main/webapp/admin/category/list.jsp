						    ...
						    <table class="t1" width=1590 height=650>
						        <tr>
						        	<td style="vertical-align: top">
						        		<table>
											<tr>
												<td align=left><b>Player list</b></td>
											</tr>
										</table>
										<table class="t1" border=1>
											...
											<tr>
												...
												<td width=60 align=center><b>Img</b></td>
												<td width=750 align=center><b>Name</b></td>
												<td width=750 align=center><b>Position</b></td>
												<th></th>
												<th></th>
											</tr>
											<thead>
											<tbody>
												<%
												String sql_count = "select count(*) from category";
												...
												String sql = "select * from category LIMIT "+first+", "+num_per_page;
												...
												while(rs.next()){
													...
													if(tab.equals("fw")){
														tab = "Forward";
													}else if(tab.equals("mf")){
														tab = "Midfielder";
													}else if(tab.equals("df")){
														tab = "Defence";
													}else{
														tab = "Goalkeeper";
													}
												%>
													<tr>
														...
														<td align=center><img src="/upload_player/<%=img%>" width=50></td>
														<td><%=title%></td>
														<td><%=tab%></td>
														<td width=50 align=center><button><a href="/admin/category/modify.jsp?uid=<%=uid%>">modify</a></button></td>
										...
										<table class="t1">
											<tr>
												<td align=right><button style="width:100px"><a href="/admin/category/write.jsp" style="color:black">Registration</a></button></td>
											</tr>
										</table>
										<table align=center>
											<tr>
