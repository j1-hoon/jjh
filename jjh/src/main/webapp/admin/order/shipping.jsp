...
function order_go(num){
	result = confirm("Is the delivery complete?");
	if(result == true){
		location.href="/admin/order/com_3.jsp?uid=" +num;
	}
}
</script>
						    ...
						    <table class="t1" width=1590 height=650>
						        <tr>
						        	<td style="vertical-align: top">
						        		<table>
											<tr>
												<td align=left><b>Shipping list</b></td>
											</tr>									
										</table>
										<table>
											<tr>
										...
										<table class="t1" border=1 align=center>
											...
											<tbody>
												<%
												String sql_count = "select count(*) from order1 where status='shipping'";
												...
												String sql = "select * from order1 where status='shipping' LIMIT "+first+", "+num_per_page;
