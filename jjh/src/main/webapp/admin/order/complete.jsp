						    ...
						    <table class="t1" width=1590 height=650>
						        <tr>
						        	<td style="vertical-align: top">
						        		<table>
											<tr>
												<td align=left><b>Complete list</b></td>
											</tr>									
										</table>
										<table>
											<tr>
										...
										<table class="t1" border=1 align=center>
											...
											<tbody>
												<%
												String sql_count = "select count(*) from order1 where status='complete'";
												...
												String sql = "select * from order1 where status='complete' LIMIT "+first+", "+num_per_page;
