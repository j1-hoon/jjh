...
function order_go(num){
	result = confirm("Have you started shipping?");
	if(result == true){
		location.href="/admin/order/com_2.jsp?uid=" +num;
	}
}
</script>
						    ...
						    <table class="t1" width=1590 height=650>
						        <tr>
						        	<td style="vertical-align: top">
						        		<table>
											<tr>
												<td align=left><b>Deposit list</b></td>
											</tr>									
										</table>
										<table>
											<tr>
										...
										<table class="t1" border=1 align=center>
											...
											<tbody>
												<%
												String sql_count = "select count(*) from order1 where status='deposit'";
												...
												String sql = "select * from order1 where status='deposit' LIMIT "+first+", "+num_per_page;
