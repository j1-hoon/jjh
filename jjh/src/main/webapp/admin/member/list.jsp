						        	...
						        	<td align=center style="vertical-align: top">
						        		<table align=left>
									       ...
									       <%
												...
												String sql = "select * from member order by signdate desc LIMIT "+first+", "+num_per_page;
									       ...
									       <tr>
									           ...
									           <td><%=z2%> <%=z3%> <%=z4%></td>
									           <td><%=signdate%></td>
									           <td width=100 align=right><button><a href="/admin/member/modify.jsp?id=<%=id%>">modify</a></button></td>
											   <td width=50 align=left><button><a onclick="delete_go(<%=id%>)">delete</a></button></td>
									       </tr>
									       		<%
												}
												rs.close();
